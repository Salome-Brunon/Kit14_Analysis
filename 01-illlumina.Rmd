...
```{r Volcano Plot, echo=FALSE, fig.height=12, fig.width=15, message=FALSE, warning=FALSE}
...
```{r, echo=FALSE}
knitr::include_graphics("~/shares-net/sequencages/analyses/cDNAKit14_A2022/deseq2_output/deseq2_Experiment1-diffana_MA_plot_LLO_vs_Neg.png")
```
...
write.table(DEA_complete, "~/Documents/Kit14_Analysis/Illumina_DEG.csv", sep = ",")
```
